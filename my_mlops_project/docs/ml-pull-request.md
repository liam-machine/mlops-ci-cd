...
Links:
* [Staging model in UC](https://dbc-c795f052-face.cloud.databricks.com/explore/data/models/staging/my_mlops_project/my_mlops_project-model)
* [Prod model in UC](https://dbc-d07466d1-7263.cloud.databricks.com/explore/data/models/prod/my_mlops_project/my_mlops_project-model)
. 
